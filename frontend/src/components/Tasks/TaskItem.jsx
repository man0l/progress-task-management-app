...
export default function TaskItem({ task, handleTaskComplete, showControls, onEdit, onDelete, onAssign }) {
    return (
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      {showControls && (
                        <>
                          <button 
                            onClick={onAssign} 
                        className="size-5 text-blue-500 hover:text-blue-700 transition-colors"
                      >
                        <HiUserCircle />
                      </button>
                      <button 
